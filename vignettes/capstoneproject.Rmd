...
# **geom_timeline<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN")) function**
* the **geom_timeline<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"))** function returns a timeline graph for a set of Countries in between specific dates. In order to work, the function uses the packages:
    * stringi
    * magrittr
    * readr 
    * dplyr
...
Some examples for using correctly and incorrectly the **geom_timeline<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"))** function are:

>_Correct_ way to use the **geom_timeline<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"))**
```{r eval=FALSE}
geom_timeline(eq_location_clean(eq_clean_data()), "1985-01-01","2015-12-31")
```

>_Incorrect_ way to use the **geom_timeline<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"))**
```{r eval=FALSE}
geom_timeline()
...
# **geom_timeline_label<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"), number=3) function**
* the **geom_timeline_label<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"), number=3)** function returns a timeline that contains in a graphical view the Earthquakes data by country and depending the number selectig it will be plotted the Location for the major number of Earthquakes with major magnitude. In order to work, the function uses these packages:
    * stringi
    * magrittr
    * readr
    * dplyr
...
Some examples for using correctly and incorrectly the **geom_timeline_label<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"), number=3)** function are:

>_Correct_ way to use the **geom_timeline_label<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"), number=3)**
```{r eval=FALSE}
geom_timeline_label(datfram)
geom_timeline_label(eq_location_clean(eq_clean_data()))
```

>_Incorrect_ way to use the **geom_timeline_label<-function(datfram, start_date="1980-01-01", end_date="2014-01-01", countries =c("MEXICO","USA", "JORDAN"), number=3)**
```{r eval=FALSE}
geom_timeline_label()
```
...
* the **eq_map_simple<-function(country ="MEXICO", annot_col="DATE", date="1980")** function returns a plot which contains the location of Earthquakes that occurred for a desired Country since a given year. In order to work, the function uses the packages:
    * stringi 
    * magrittr
    * readr
    * dplyr
    ...
    * ggmap 
    * stringi
    * the parameters **country** and **date** which represents the Country and the given year from where the Earthquake's data will be diplayed. If the  parameters **country & date** are not provided, this function will plot the Earquakes that occured in Mexico since 1980. 
```{r eval=FALSE}
eq_map_simple<-function(country ="MEXICO", annot_col="DATE", date="1980"){
...
Some examples for using correctly and incorrectly the **eq_map_simple<-function(country ="MEXICO", annot_col="DATE", date="1980")** function are:

>_Correct_ way to use the **eq_map_simple<-function(country ="MEXICO", annot_col="DATE", date="1980")**
```{r eval=FALSE}
eq_map_simple()
eq_map_simple("USA")
```

>_Incorrect_ way to use the **eq_map_simple<-function(country ="MEXICO", annot_col="DATE", date="1980")**
```{r eval=FALSE}
eq_map_simple("USA","ALL","1980")
```
